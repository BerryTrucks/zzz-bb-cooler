        ...
        Container { // BODY - START
            ...
            ColorPickerView {
                ...
                ColorWheelView {
                    ...
                    preferredWidth: expanded ? colorPickerView.preferredWidth / 2 : colorPickerView.preferredWidth
            ...
            Container {
                ...
                Container { // COLOR CODES - START
                    ...
                    Container { // RGB - START
                        ...
                        Container {
                            ...
                            Label {
                                text: "<span style='font-size: 60px; font-weight: 700;'>" + rgb + "</span>"
                            ...
                            Container {
                                topPadding: 70
                                Label {
                                    text: "<span style='font-size: 20px; letter-spacing:2px'>RGB</span>"
                                    textStyle.color: Color.White
                                    textFormat: TextFormat.Html
                                }
                            }
                    ...
                    Container { // HEX - START
                        ...
                        Container {
                            ...
                            verticalAlignment: VerticalAlignment.Center
                            Label {
                                text: "<span style='font-size: 60px; font-weight: 700;'>" + hex.substring(2, hex.length) + "</span>"
                                textFormat: TextFormat.Html
                                textStyle.color: Color.White
                                textStyle.fontWeight: FontWeight.W100
                                textStyle.textAlign: TextAlign.Center
                            ...
                            Container {
                                ...
                                horizontalAlignment: HorizontalAlignment.Right
                                Label {
                                    text: "<span style='font-size: 20px; letter-spacing:2px'>HEX</span>"
                                    textStyle.color: Color.White
                                    textFormat: TextFormat.Html
                                }
                            }
                ...
                Container { // SELECTED COLOR - START
                    ...
                    horizontalAlignment: HorizontalAlignment.Fill
                    minHeight: (ddColorRule.selectedOption.text == 'None' && expanded) ? 300 : 150
